...
if [[ "$choice" =~ ^[Yy]$ ]]; then
    ssh -t "$remote_user"@"$remote_host" "cd /home/edge-oriented-graph-master-studying/results/vlsp-test/ && pwd &&  ls -ltlh && rm -r /home/edge-oriented-graph-master-studying/results/vlsp-test-new/* && ls"
